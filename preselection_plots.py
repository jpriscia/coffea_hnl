...
exclude = {'DYJetsToLL_M-50_FXFX'}
target_lumi = 59.7e3 # /pb
scaling = utils.compute_weights(
    f'inputs/{args.jobid}/mc.meta.json', target_lumi,
    '/home/ucl/cp3/jpriscia/CMSSW_10_2_15_patch2/src/HNL/HeavyNeutralLeptonAnalysis/test/input_mc_2018.yml'
)
...
for key, x_title in plots:
    ...
    lumi = plt.text(
        1., 1., f'{target_lumi/1000}'r" fb$^{-1}$ (13 TeV)",
        fontsize=16, 
    ...
    plt.savefig(f'plots/{args.jobid}/{key}.pdf')
    plt.savefig(f'plots/{args.jobid}/{key}.png')
